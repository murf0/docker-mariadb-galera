#!/bin/bash
#
# Based on the script by https://github.com/olafz/percona-clustercheck
# Added the usage of already present environment variables.
...
MYSQL_USERNAME=$(echo ${wsrep_sst_auth} | awk -F: '{print $1}')
MYSQL_PASSWORD=$(echo ${wsrep_sst_auth} | awk -F: '{print $2}')
